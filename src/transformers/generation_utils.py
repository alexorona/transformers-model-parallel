    ...
    def generate(
        ...
        **model_kwargs
        ...
        if self.config.is_encoder_decoder:
            ...
            # ensure encoder_outputs.last_hidden_state is on the same device as input_ids
            encoder_outputs.last_hidden_state = encoder_outputs.last_hidden_state.to(input_ids.device) 
