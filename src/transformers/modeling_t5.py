...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #     print('len of decoder_input_ids @ 1:', len(decoder_input_ids[0]))
        #     print('decoder_input_ids @ 1:', decoder_input_ids)
        #     print('decoder_attention_mask  @ 1:', decoder_attention_mask)
        # else:
        #     print('no decoder input ids')

        # print('len of input_ids @ 1:', len(input_ids[0]))
        ...
        # print('len of decoder_input_ids @ 2:', len(decoder_input_ids[0]))
        # print('decoder_input_ids @ 2:', decoder_input_ids)
        # print('decoder_attention_mask  @ 2:', decoder_attention_mask)
